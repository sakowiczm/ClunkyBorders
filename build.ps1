# Build and Publish Script for ClunkyBorders
param(
...
Write-Host "=== ClunkyBorders Build Script ===" -ForegroundColor Green
...
$PublishTempDir = Join-Path $SourceDir "bin\$Configuration\net10.0-windows10.0.17763.0\win-x64\publish"
